            ...
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item">
                    <a class="navbar-brand" href="html/ltr/horizontal-menu-template/index.html">
                        <div class="brand-logo"> <img src="app-assets/images/logo/logo_app.png" alt=""></div>
                    </a>
                </li>
            </ul>
        </div>
                    ...
                    <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                        ...
                        <ul class="nav navbar-nav">
                            <li class="nav-item mr-auto">
                                <a class="navbar-brand" href="index.php"> <h2 class="brand-text mb-0">GestionSyndic</h2></a>
                            </li>
                        </ul>
                    </div>
